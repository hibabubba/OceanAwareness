...
import com.example.prosjekt.OceanAwareness.Activity.Dataclasses.SetImage
import com.example.prosjekt.Locationforecast.Locationforecast
import com.example.prosjekt.R
import com.example.prosjekt.OceanAwareness.Activity.Repository.LocationRepository
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.launch

class LocationActivityViewModel : ViewModel() {
    private lateinit var setImage: SetImage

    private val repository = LocationRepository()
    private var liveData: MutableLiveData<Locationforecast> = repository.liveDataForecast
    ...
    fun setDataImage(counterRain: Int, tell: Int , nr: Int , data: Locationforecast?): SetImage {
            var teller = tell
            var tellerRegn = counterRain
